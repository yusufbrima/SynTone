...
def main(n=0, num_epochs=0):
    ...
    if num_epochs == 0:
        ...
        epoch_str  = f"_{num_epochs}"
    # List of model paths to evaluate
    print(f"\nEvaluating Model: {num_epochs}")
    model_list = [f'./Exports/vae2deep_8{epoch_str}.pth', f'./Exports/betavae2deep_8{epoch_str}.pth', f'./Exports/btcvae2deep_8{epoch_str}.pth',f'./Exports/factorvae2deep_8{epoch_str}.pth']
    ...
    df.to_csv(f'./Data/50epochs/metrics_{n}.csv', index=False)
